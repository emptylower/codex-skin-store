export const messages = {
  ...
  community: {
    favoritesLibrary: "Your favorites",
    favoritesEmpty: "You have not saved any themes yet.",
    ...
    reportReasonMalware: "Malware or unsafe",
    reportReasonSpam: "Spam",
    reportReasonOther: "Other",
    reportedThanks: "Thanks — your report was received.",
