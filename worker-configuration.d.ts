/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 305c66ad67e1f89964bce3f5c99cd0ad)
...
interface __BaseEnv_Env {
	...
	ZIP_WRITER: "fflate";
	/** Better Auth secret (set via wrangler secret / .dev.vars). */
	BETTER_AUTH_SECRET: string;
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	GITHUB_CLIENT_ID: string;
	GITHUB_CLIENT_SECRET: string;
	/** R2 S3 API credentials for presigned uploads (later tasks). */
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "DEFAULT_LOCALE" | "ENABLE_GIF_UPLOADS" | "ZIP_WRITER">> {}
}
